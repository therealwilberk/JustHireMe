...
async def _run_x_signal_scan(cfg: dict, profile: dict | None = None) -> list[dict]:
    ...
    try:
        ...
        leads = await asyncio.to_thread(
            ...
            raw_queries=cfg.get("x_search_queries", "") or _profile_x_queries(profile or {}),
...
async def _run_free_source_scan(cfg: dict, profile: dict | None = None) -> list[dict]:
